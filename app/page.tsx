...
export default async function Page() {
  ...
  if (!account) return <div style={{color: 'white', padding: '40px', textAlign: 'center', background: 'black', minHeight: '100vh'}}>Connect Supabase and add an account to start.</div>;
